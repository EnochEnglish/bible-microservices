 ...
 *   2. regression test (API data contract for frontend)
 *   3. back‑end API tests
 *   4. front‑end JS tests
 *   5. front‑end HTML tests
 *
...
const suites = [
  ...
  ["Regression test",   `${__dir}/regression.test.js`],
